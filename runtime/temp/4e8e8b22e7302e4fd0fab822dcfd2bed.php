<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\code\hrsystem\public/../application/admin\view\typeworks\add.html";i:1616387747;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="<?php echo url('adddata'); ?>" class="form-horizontal m-t" id="commentForm" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-1">
                                                ...
                                                <div class="form-submit">
                                                    <input type="text" class="input-text" value="" placeholder="" id="workingageid" name="workingage">
                                                </div>
                                                <br>
                                                ...
                                                <div class="form-submit">
                                                    <input type="text" class="input-text" value="" placeholder="" id="levelid" name="levelname">
                                                </div>
                                                <br>
                                                ...
                                                <div class="form-submit">
                                                    ...
                                                    <label class="col-sm-1 control-label">
                                                        <a onclick="addabcsalary123(this);" href="#" style="margin-right: 10px"> [ + ] </a>  <!--按+增加种类-->
                                                        ABC薪资
                                                    </label>
                                                ...
                                                <div class="tab-pane" id="tab-3">
                                                    <div class="form-group">
                                                        <label class="col-sm-1 control-label">
                                                            <a onclick="addabcsalary(this);" href="#" style="margin-right: 10px"> [ + ] </a>  <!--按+增加种类-->
                                                            评价内容
                                                        </label>
                                                        <div class="col-sm-11">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <select id="province" name="pid" class="form-control m-b help-block m-b-none" required="" aria-required="true">
                                                         <?php foreach($typeworks as $vo): ?>
                                                            <option value="<?php echo $vo['id']; ?>" ><?php echo $vo['level']; ?>级&nbsp;<?php echo $vo['name']; ?></option>
                                                            <?php endforeach; ?>
