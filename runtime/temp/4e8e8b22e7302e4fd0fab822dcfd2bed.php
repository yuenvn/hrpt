<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\code\hrsystem\public/../application/admin\view\typeworks\add.html";i:1616991896;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="<?php echo url('adddata'); ?>" class="form-horizontal m-t" id="commentForm" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-1">
                                                ...
                                                <div class="form-submit">
                                                    <input type="text" class="input-text" value="" placeholder="" id="jobtitleid" name="jobtitle">
                                                </div>
                                                <br>
