<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\code\hrsystem\public/../application/admin\view\typeworks\lists.html";i:1616732793;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <?php if(is_array($typeworks) || $typeworks instanceof \think\Collection || $typeworks instanceof \think\Paginator): $i = 0; $__LIST__ = $typeworks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
                                            <tr id="<?php echo $value['id']; ?>" pid="<?php echo $value['pid']; ?>" >
                                                ...
                                                <td >
                                                    <?php echo str_repeat(' ——— ',$value['level']*1);  ?><a title="点击可查看组织文档并添加该组织文档" href="<?php echo url('Content/lists',['typeworks_id'=>$value['id']]); ?>"><?php echo $value['position']."--".$value['jobtitle']; ?></a>
                                                ...
                                                <td >
                                                    <a> <?php echo $value['codelevel']; ?></a>
                                                </td>
                                                <td >
                                                    <a> <?php echo $value['abclevel']; ?></a>
                                                </td>
                                                <td >
                                                    <a><?php echo $value['basicsalary']; ?></a>
                                                </td>
                                                <td width="13%">
